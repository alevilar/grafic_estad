	...
	<div id="header">
    	<div class="container">
    		...
    		<div class="top-section">
 	 	    ...
 	 	    <h1 class="logo">
                            <?php 
                            $logoImgs = $this->Html->image('/login/images/logo.png');
                ...
                <div class="col1 columns">
                	<div class="boxes">                    
                        ...
                        <div class="camera_wrap" id="camera_wrap_1">
                            <div data-thumb="<?php echo $this->Html->url('/login/images/slides/banner1.jpg')?>" data-src="<?php echo $this->Html->url('/login/images/slides/banner1.jpg')?>">
                             ...
                             <div data-thumb="i<?php echo $this->Html->url('/login/images/slides/banner2.jpg')?>" data-src="<?php echo $this->Html->url('/login/images/slides/banner2.jpg')?>">
                                <div class="camera_caption fadeFromBottom">
                                   <p class="tite">Curabitur eget nunc tortor</p>
                                    <p class="subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a nisl non sem lobortis vulputate at eget turpis. Sed ut nisl tempor, posuere velit a, consequat sem.</p>
                                </div>
                            </div>
                            <div data-thumb="<?php echo $this->Html->url('/login/images/slides/banner3.jpg')?>" data-src="<?php echo $this->Html->url('/login/images/slides/banner3.jpg')?>">
                                <div class="camera_caption fadeFromBottom">
                                    <p class="tite">Curabitur eget nunc tortor</p>
                                    <p class="subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a nisl non sem lobortis vulputate at eget turpis. Sed ut nisl tempor, posuere velit a, consequat sem.</p>
                                </div>
                            </div>
                             <div data-thumb="<?php echo $this->Html->url('/login/images/slides/banner4.jpg')?>" data-src="<?php echo $this->Html->url('/login/images/slides/banner4.jpg')?>">
                                <div class="camera_caption fadeFromBottom">
                                    <p class="tite">Curabitur eget nunc tortor</p>
                                    <p class="subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a nisl non sem lobortis vulputate at eget turpis. Sed ut nisl tempor, posuere velit a, consequat sem.</p>
                                </div>
                            </div>
                            <div data-thumb="<?php echo $this->Html->url('/login/images/slides/banner5.jpg')?>" data-src="<?php echo $this->Html->url('/login/images/slides/banner5.jpg')?>">
                                <div class="camera_caption fadeFromBottom">
                                    <p class="tite">Curabitur eget nunc tortor</p>
                                    <p class="subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a nisl non sem lobortis vulputate at eget turpis. Sed ut nisl tempor, posuere velit a, consequat sem.</p>
                                </div>
