  ...
  public function afterSave( Model $Model, $created ) {
    ...
    if( count( $updates ) ) {
      foreach( $updates as $delta ) {
        ...
        if ( is_array($delta['AuditDelta']['new_value']) ||  is_array($delta['AuditDelta']['old_value']) ){
            continue;
        }
        if ( is_object($delta['AuditDelta']['new_value']) ||  is_object($delta['AuditDelta']['old_value']) ){
            continue;
        }
