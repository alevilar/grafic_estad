 ...
 */
class AclController extends ForumAdminAppController {
	...
	public function beforeFilter() {
		...
		$this->Aco = Admin::introspectModel('ForumAdmin.ControlObject');
		$this->Aro = Admin::introspectModel('ForumAdmin.RequestObject');
		$this->Permission = Admin::introspectModel('ForumAdmin.ObjectPermission');
