...
App::uses('Admin', 'ForumAdmin.Lib');
App::uses('ActionLog', 'ForumAdmin.Model');
App::uses('AppController', 'Controller');
/**
 * @property Model $Model
 * @property AdminToolbarComponent $AdminToolbar
 */
class ForumAdminAppController extends Controller {
	...
	public $components = array(
		...
		'Utility.AutoLogin', 'ForumAdmin.AdminToolbar',
		'Auth' => array(
	...
	public $helpers = array(
		...
		'Utility.Breadcrumb', 'Utility.Utility', 'ForumAdmin.Admin'
	);
	...
	public function isAuthorized($user = null) {
		...
		$aro = Admin::introspectModel('ForumAdmin.RequestObject');
