...
class InstallShell extends BaseInstallShell {
	 ...
	 * @var array
	 */
	public $uses = array('ForumAdmin.RequestObject', 'ForumAdmin.ControlObject', 'Permission');
	...
	public function main() {
		...
		$this->out('Plugin: Admin v' . Configure::read('ForumAdmin.version'));
