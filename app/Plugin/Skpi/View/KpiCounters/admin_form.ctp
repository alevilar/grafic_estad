...
if ($this->action == 'admin_edit') {
	$this->Html->addCrumb($this->data['KpiCounter']['name'], '/' . $this->request->url);
	$this->viewVars['title_for_layout'] = 'Sky Counter: ' . $this->data['KpiCounter']['name'];
} else {
	$this->Html->addCrumb(__d('croogo', 'Add'), '/' . $this->request->url);
}

echo $this->Form->create('KpiCounter');
